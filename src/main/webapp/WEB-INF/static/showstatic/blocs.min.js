...
function setUpSpecialNavs() {
    $(".navbar-toggler").click(function (t) {
        var a, e, o = $(this).closest("nav"), i = o.find("ul.site-navigation"), l = i.clone();
...
function setUpClassToggle() {
    $(document).on("click", "[data-toggle-class-target]", function (t) {
        t.preventDefault();
        var a, e = $(this).attr("data-toggle-class-target"), o = $(this).attr("data-toggle-class");
