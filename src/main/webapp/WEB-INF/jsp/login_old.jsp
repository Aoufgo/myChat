...
<div id="login_div" class="login_div animate__animated animate__fadeInUp animate__faster">
    <!-- 导航栏 -->
    <div id="login_title_div" class="login_title_div">
    </div>
    <!-- 切换登录 -->
    <div class='navi'>
        <ul>
    ...
    <div class='div_numberLogin' id='numberLogin'>
        <form name='numberLogin_form' method="post" action="${pageContext.request.contextPath}/user/login">
            ...
            <p><i class="far fa-smile-wink" style="size:1px"></i>
                <a data-target="#faceLogin"  onclick="ff()" style="cursor: pointer"><font style="font-size: 13px">人脸登录  </font></a>
                <a onclick="forgetPassword()" style="cursor: pointer"><font style="font-size: 13px">忘记密码?  </font></a>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i data-feather="edit-2" class="mr-2"></i> 人脸登录
                </h5>
